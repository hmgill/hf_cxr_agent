...
Each tool wraps one sub-skill's tool module. See `agents/cxr-orchestrator/orchestrator_agent.py`.
...
- See [agents/cxr-orchestrator/orchestrator_agent.py](../../agents/cxr-orchestrator/orchestrator_agent.py) for the runnable agent.
